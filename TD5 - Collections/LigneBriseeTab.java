...
public class LigneBriseeTab {
	...
	public LigneBriseeTab(Point[] points) {// fonction constructeur enfant
	...
	public LigneBriseeTab deletePoint(Point p) {//on met en paramètre le point à supp
		...
		if(this.contientPoint(p)==true) {
			...
			LigneBriseeTab new_ligne = new LigneBriseeTab(new Point[dim-1]);
